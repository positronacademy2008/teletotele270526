...
# SECRETS (Safe get use kiya hai taaki crash na ho)
...
def publish_to_wp(title, content):
    if not WP_URL or not WP_USER or not WP_PASS:
        print("WordPress Secrets missing!")
        return None
...
def rewrite_with_ai(raw_text):
    ...
    try:
        ...
        prompt = f"Rewrite this news for an educational blog. No source links. Language: Hindi/Hinglish. Use HTML tags. Text: {raw_text[:4000]}"
